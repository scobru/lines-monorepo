...
const LineTweets: NextPage = () => {
  ...
  return (
    <>
      ...
      <div className="flex items-center flex-col  w-full justify-center text-left">
        ...
        <div className="flex flex-col justify-center items-left min-w-full text-left">
          <div className="text-xl font-bold align-text-top items-start justify-start text-left p-10  h-full">
            <UsersIcon className=" w-8 h-8" />
            {""} <div className="font-base"> {followerCount} </div>
          </div>{" "}
          {listTweet.map((tweet, index) => (
            <div className="card card-body card-compact card-bordered w-full mx-auto" key={index}>
              <div className="border-2 border-accent w-full bg-base-300">
